...
export function privacyPage3() {
  ...
  <section class="chapter bt0" id="privacy" tabindex="-1"><div class="wrap">
    ...
    ${row("join the genix mind waitlist (open on this site on 25 September 2026, now closed)", "your email, where you came from, and the same daily visitor hash", "until you ask us to remove it; used only to write to you when genix mind is ready to try, never to charge you")}
