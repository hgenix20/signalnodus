...
export function privacyPage3() {
  ...
  <section class="chapter bt0" id="privacy" tabindex="-1"><div class="wrap">
    ...
    ${row("join the genix mind waitlist at <a href=\"/mind\">/mind</a>", "your email, where you came from, and the same daily visitor hash", "until you ask us to remove it; used only to write to you when genix mind is ready to try, never to charge you")}
