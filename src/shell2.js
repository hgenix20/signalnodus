...
@media (max-width: 860px) { .hero .wrap { grid-template-columns: 1fr; gap: 8px; } .hero .globe-stage { height: 44vh; min-height: 260px; max-height: 400px; } }
@media (max-height: 480px) and (orientation: landscape) { .hero .globe-stage { height: 70vh; min-height: 200px; max-height: 320px; } .hero .wrap { grid-template-columns: minmax(0, 1fr) minmax(0, 1fr); gap: 16px; } .stats { grid-template-columns: repeat(3, minmax(0, 1fr)); } }
